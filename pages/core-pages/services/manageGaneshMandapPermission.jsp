...
<div class="mainHdr">
	<h3 style="height: 30px; font-size: 15px; color: #01293d">
		...
		<fmt:message key="Application form for Ganesh Mandap Permission" /> :
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${mandapPermission.ganeshMandapPermissionId}">
	<c:set var="doc"
...
एकावेळी मंडपात उपस्थित राहू शकणार्‍या एकूण भाविकांची संख्या)" />:</span>
		...
		<tr>
			...
			<td colspan="6"
				style="background-color: white; background-color: #cacdd4;"><span
				class="ClsLabel"
				style="height: 37px; padding: 7px 10px 11px; font-size: 14px; color: #01293d; font-style: italic;"><fmt:message
						key="Area/Size of Pavilion (मंडपचे क्षेत्रफळ/आकार)" />:</span></td>
		...
		<tr>
			...
			<td colspan="6"
				...
				class="ClsLabel"
				style="height: 37px; padding: 7px 10px 11px; font-size: 14px; color: #01293d; font-style: italic;"><fmt:message
						key="Entry Gate Size (प्रवेशद्वार आकार)" />:</span></td>
		</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Length (लांबी)" />:</span></td>
	...
	<tr>
			...
			<td colspan="6"
				...
				class="ClsLabel"
				style="height: 37px; padding: 7px 10px 11px; font-size: 14px; color: #01293d; font-style: italic;"><fmt:message
						key="Advertisement Size(जाहिरात आकार)" />:</span></td>
		</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Length (लांबी)" />:</span></td>
	...
	<%-- 	
		<tr>
			...
			<td colspan="7">
				<table width="100%" border="0" >
			<td colspan="4"
				style="background-color: white; background-color: #cacdd4;max-width: 100%"><span
				class="ClsLabel"
				style="height: 37px; padding: 7px 10px 11px; font-size: 14px; color: #01293d; font-style: italic;"><fmt:message
						key="Duration of Sounding Permit
							(ध्वनीक्षेपणाच्या परवानगीचा कालावधी)" />:</span></td>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Date of Ganapati immersion (गणपती  विसर्जनाची  तारीख)" />:</span></td>
			<td colspan="2"><input type="text" class="form-control"
				id="" maxlength="10"
				name=""
				value="<c:out value="${mandapPermission.ganeshimmersion}"/>" disabled/></td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Place of Ganpati Visarjan (गणपती विसर्जन चे ठिकाण)" />:</span></td>
			<td colspan="2">
			<textarea class="form-control"
				id="noOfCertificateCopies"
				name="noOfCertificateCopies"
			 disabled>${mandapPermission.ganeshVisarjan}</textarea>
			</td>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Ganesh idol is made of which material (गणेशमूर्ती कुठल्या प्रकारची आहे)" />:</span></td>
			<td colspan="2"><input type="text" class="form-control"
				id="noOfCertificateCopies" maxlength="10"
				name="noOfCertificateCopies"
	...
	<tr>
				...
				class="ClsLabel"
				style="height: 37px; padding: 7px 10px 11px; font-size: 14px; color: #01293d; font-style: italic;"><fmt:message
						key="Requirements for No Objection Certificate of Fire Department (अग्निशमन विभागाच्या ना हरकत प्रमाणपत्राची आवश्यकता)" />:</span></td>
	...
	<td colspan="7">
            ...
            <tr>
                       <td>
							<span class="ClsLabel" style="font-size: 12px !important;"><fmt:message key="Is the height of the idol to be installed more than 4 feet?" /> </span>
		                   							<span class="ClsLabel" style="font-size: 12px !important;"><fmt:message key="स्थापन करण्यात येणाऱ्या मूर्तीची उंची ४ फूट पेक्षा जास्त आहे काय ?" /> </span></td>
						...
						<tr>
						<td>
							<span class="ClsLabel" style="font-size: 12px !important;"><fmt:message key="Is there going to be a kitchen and firecrackers for fuel prasad in the mandap?" /> </span>
						...
						<tr>
						<td>
							<span class="ClsLabel" style="font-size: 12px !important;"><fmt:message key="Will alternate power arrangements be made available in the form of emergency generators?" /> </span>
							<span class="ClsLabel" style="font-size: 12px !important;">आपत्कालीन परिस्थिती जनरेटर च्या स्वरूपात पर्यायी विधुत व्यवस्था उपल उपलब्ध ठेवण्यात येणार आहे काय ?</span></td>
						...
						<tr>
						<td>
							<span class="ClsLabel" style="font-size: 12px !important;"><fmt:message key="Is permission taken for loudspeakers?" /> </span>
							<span class="ClsLabel" style="font-size: 12px !important;">लाऊड स्पीकर ची परवानगी घेतली आहे काय ?</span></td>
						...
						<tr>
						<td>
							<span class="ClsLabel" style="font-size: 12px !important;"><fmt:message key="Has all electrical wiring and equipment installation in the pandal been carried out by a Licensed Electrical Contractor as per applicable safety standards?" /> </span>
							<span class="ClsLabel" style="font-size: 12px !important;">मंडपातील संपूर्ण विद्युत वायरिंग व उपकरणांची स्थापना परवानाधारक विद्युत कंत्राटदारामार्फत लागू सुरक्षा मानकांनुसार करण्यात आले आहे का?</span></td>
						<td>${mandapPermission.parkingStorage}</td>
						
						</tr>
						<tr>
						<td>
							<span class="ClsLabel" style="font-size: 12px !important;"><fmt:message key="Has approved Fire-Retardant Treatment been provided to all fabric/cloth used for the pandal?" /> </span>
							<span class="ClsLabel" style="font-size: 12px !important;"> मंडपासाठी वापरण्यात आलेल्या सर्व कापडी आच्छादनास मान्यताप्राप्त Fire-Retardant Treatment करण्यात आले आहे का?</span></td>
	...
	<tr id="certificateActive">
		...
		<tr>
			...
			<td style="width: 230px; height: 30px"><span class="ClsLabel" style="font-size:14px;color:forestgreen;"> <c:if
					...
					<c:if
						test="${requestScope.rtiApplication.workFlowStatus==3}">
						Citizen Payment Pending
					</c:if>
					 <c:if test="${requestScope.rtiApplication.workFlowStatus==2}">
					
					<c:choose>
                        <c:when test="${requestScope.rtiApplication.applicationCost==0.0}">
...
<a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
			...
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Affidavit as per High Court order (उच्च न्यायालयाच्या आदेशानुसार प्रतिज्ञापत्र)" />:</span> 
												<td style="text-align: center" colspan="3.5">
<a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<!-- Files Uploading -->
<c:if test="${requestScope.forLogin eq 'L1' ||  requestScope.forLogin eq 'L2' || requestScope.rtiApplication.workFlowStatus==2 || requestScope.rtiApplication.workFlowStatus==1 || requestScope.rtiApplication.workFlowStatus==5}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
        ...
        <c:when test="${empty mandapPermission.policeNoc}">
			...
			<hr>
<button style="margin-right: 15px; margin-top: 2px;" id="policeSampleDoc" onclick="policedownload(${mandapPermission.rti_ref_id},'policeNocCertificateReport.do')">Download Sample NOC</button>
			</td>
                 <td>
...
<c:if test="${requestScope.forLogin eq 'L1' || requestScope.forLogin eq 'L2' || requestScope.rtiApplication.workFlowStatus==2 || requestScope.rtiApplication.workFlowStatus==1 || requestScope.rtiApplication.workFlowStatus==5}">
        ...
        <td style="text-align: center" colspan="3.5">
				...
				<hr>
<button style="margin-right: 15px; margin-top: 2px;" id="trafficSampleDoc"  onclick="trafficdownload(${mandapPermission.rti_ref_id},'trafficNocCertificateReport.do')">Download Traffic NOC</button>
			</td>
            <td>
...
<c:if test="${requestScope.forLogin eq 'L3' || requestScope.rtiApplication.workFlowStatus==2 || requestScope.rtiApplication.workFlowStatus==1 || requestScope.rtiApplication.workFlowStatus==5}">
...
अग्निशमन विभागाकडून एनओसी)" />:</span> 
        ...
        <c:when test="${empty mandapPermission.fireNoc}">
				...
				<hr>
<button style="margin-right: 15px; margin-top: 2px;" id="fireSampleDoc"  onclick="firedownload(${mandapPermission.rti_ref_id},'fireNocCertificateReport.do')">Download Fire NOC</button>
											<td style="text-align: center" colspan="3.5">
...
<td colspan="4" align="center"><input type="button"
	...
	<input type="hidden" class="ClsTextbox_mr" style="width: 180px"
		id="ganeshMandapPermissionId" maxlength="12" name="ganeshMandapPermissionId"
		value="<c:out value="${mandapPermission.ganeshMandapPermissionId}"/>" /> 
...
<div style="padding: 10px;background-color: #f7f7f7;">
	...
	$(document).ready(function() {
	    var userLevel ="${requestScope.forLogin}"; 
	    $('#certificateActive').hide();
	    if (userLevel==='L4') {
    ...
    function complete() {
        ...
        if (remarks !== "") {
            if (confirm("Do you really want to close the application?")) {
                ...
                onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/createGaneshMandapPermissionWork.do?cid=1');
            } else {
                return false;
            }
        } else {
    ...
    function reject() {
        ...
        if (remarks !== "") {
            if (confirm("Do you really want to reject the application?")) {
                onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/createGaneshMandapPermissionWork.do?cid=5');
            } else {
                return false;
            }
        } else {
...
if(fireRemarks !== null && fireRemarks !== undefined){
    ...
    if (flag) {
        onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveGaneshMandap.do');
    }
}
</script>
    ...
    function uploadPoliceNoc() {
        ...
        for (var i = 0; i < file.length; i++) {
   			...
   			const value = splitName + ".pdf";
                ...
                filesPath = filesPath + basePath + "ganeshPermission/" + i + value + ","
                isFileSelected = true;
            }
        }
        var appType = 1;
        var uid1 = document.getElementById('ganeshMandapPermissionId').value;
        $.ajax({
            url: "<c:out value='${contextRoot}'/>/rtsapplication/uploadGaneshMandapNoc.do?appType="+appType+"&UID="+uid1,
            type: 'POST',
            data: data,
            cache: false,
            dataType: 'json',
